...
<p align="center">
    ...
    id="Country_Service_Nordea?trk=public_profile_see-credential"    
...
- We are making `application.yml` for these microservices.
    - If this microservice woud run in different environment, it would pick up appropriate configurations. 
...
- [![Resilience](https://img.shields.io/badge/Resilience-Retry_Pattern-success?style=for-the-badge)](https://projectreactor.io/docs/core/release/api/reactor/util/retry/Retry.html)
    - The [theory](https://github.com/developersCradle/reactive-programming/tree/main/Spring%20WebFlux%20Microservices%20Patterns%20and%20Advanced%20Resilience/Section%2008#retry-pattern---intro) implemented here!
...
<details>
<summary id="Be_Api_Documentation">Back end <b>API documentation</b> </summary>
...
### **GET /countries/v1/**
   ...
   - **Response**:
     ...
     - If no data is found, it rqeturns a `404 Not Found` status.
   - **Example Response**:
     ```Json
     {
           "countries": [
...
<p align="center">
    <img src="Catching_The_Netty_Headers_Request.PNG" width="500"  height="300">
    <img src="Catching_The_PostMan_Headers_Request.PNG" width="500" height="300">
</p>
...
<p align="center">
    <img  src="Post_Api_Finding.PNG" alt="Post api finding!" width="600"/>
</p>
...
<p align="center">
    <img  src="No_Redirect_Captured.PNG" alt="No redirect captured picture!" width="600"/>
</p>
...
<p align="center">
    <img  src="Post_API_Response.PNG" alt="Post API response!" width="600"/>
</p>
...
<p align="center">
    <img  src="Post_API_Response_Second.PNG" alt="Post API response!" width="600"/>
</p>
